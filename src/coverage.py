...
'''Per capita availability of green cover is also an important indicator to determine whether green cover is sufficient for each
...
mun_area_sqm = census['st_area_shape'].sum()
...
green_area_per_zone = parks_with_census.groupby('zona')['st_area_shape_left'].sum().reset_index()
green_area_per_zone['green_area_ha'] = green_area_per_zone['st_area_shape_left'] / 10000
...
data_by_zone['sqm_per_person'] = data_by_zone['st_area_shape_left']/data_by_zone['population']
